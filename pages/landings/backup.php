...
<link rel="stylesheet" href="../../assets/css/theme.min.css">
        ...
        <title>Scholar Hub By Team Logic Lords</title>
    </head>
    ...
    <div class="container-fluid px-0">
        ...
        <div class="order-lg-3">
            <div class="d-flex align-items-center">
                ...
                <a href="https://geeksui.codescandy.com/geeks/pages/sign-in.html" class="btn btn-outline-primary ms-2 d-none d-lg-block">Sign in</a>
                <a href="https://geeksui.codescandy.com/geeks/pages/sign-up.html" class="btn btn-primary ms-2 d-none d-lg-block">Sign up</a>
                <!-- Button -->
                <button
        ...
        <div class="collapse navbar-collapse" id="navbar-default">
            <ul class="navbar-nav mx-auto">
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#" id="navbarLanding" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Home</a>
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#" id="navbarPages" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Find Scholarships
                    </a>
                    <ul class="dropdown-menu dropdown-menu-arrow" aria-labelledby="navbarPages">
                        <li class="dropdown-submenu dropend">
                            <a class="dropdown-item dropdown-list-group-item dropdown-toggle" href="find.html">Find Scholarships</a>
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">AI Assistant</a>
                    <ul class="dropdown-menu dropdown-menu-arrow">
                        <li>
                            <h4 class="dropdown-header">AI Assistant</h4>
                        </li>
                        <li class="dropdown-submenu dropend">
                            <a class="dropdown-item dropdown-list-group-item dropdown-toggle" href="ai.html">AI Assistant Link</a>
                            <ul class="dropdown-menu">
                ...
                <li class="nav-item dropdown dropdown-fullwidth">
                    <a class="nav-link dropdown-toggle" href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Community QNA</a>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-6 mb-6 mb-lg-0">
                            <div>
                                ...
                                <!-- heading -->
                                <h1 class="display-3 fw-bold mb-3"><h1>Find Scholarships with Scholar Hub</h1></h1>
                                <!-- para -->
                                <p class="pe-lg-10 mb-5">
                                   
Launch your scholarship journey with access to over 5,000 opportunities, including courses, Professional Certificates, and degrees offered by prestigious institutions globally.
                                </p>
                                <!-- btn -->
                                <a href="#" class="btn btn-primary">Personlize</a>
                                <a href="#" class="btn btn-primary">Find With AI</a>                <!-- find with ai button hyper link tag ramianing -->
                                <a href="https://www.youtube.com/watch?v=Nfzi7034Kbg" class="glightbox fs-4 text-inherit ms-3">
                                    <img src="https://geeksui.codescandy.com/geeks/assets/images/svg/play-btn.svg" alt="play" class="me-2" />
                                    Watch Demo
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6 d-flex justify-content-center">
                            ...
                            <div class="position-relative">
                                <img src="https://geeksui.codescandy.com/geeks/assets/images/background/acedamy-img/bg-thumb.svg" alt="img" />
                                ...
                                <img src="https://geeksui.codescandy.com/geeks/assets/images/background/acedamy-img/frame-1.svg" alt="frame" class="position-absolute top-0 ms-n8 d-none d-md-inline-block" />
                                <img
                                ...
                                <img src="https://geeksui.codescandy.com/geeks/assets/images/background/acedamy-img/target.svg" alt="target" class="position-absolute bottom-0 mb-8 ms-n8 ms-lg-n1 d-none d-md-inline-block" />
                                <img
                                    ...
                                    style="left: -100px" />
                                <img src="https://geeksui.codescandy.com/geeks/assets/images/background/acedamy-img/trophy.svg" alt="trophy" class="position-absolute top-0 start-0 ms-n8 d-none d-md-inline-block" />
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 col-lg-3 border-top-md border-bottom border-end-md">
                            ...
                            <div class="py-7 text-center">
                                ...
                                <div class="lh-1">
                                    <h2 class="mb-1">10+</h2>
                                    <span>Types Of Scholarship</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-lg-3 border-top-lg border-bottom border-end-md">
                            ...
                            <div class="py-7 text-center">
                                ...
                                <div class="lh-1">
                                    ...
                                    <span>Applied Through Our Portal</span>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-3 border-top-lg border-bottom">
                            ...
                            <div class="py-7 text-center">
                                ...
                                <div class="lh-1">
                                    ...
                                    <span>Online Tutorial Videos</span>
                                </div>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <section class="py-8">
                                        <div class="container">
                                            <div class="row">
                                                <div class="offset-md-2 col-md-8 col-12">
                                                    <div class="mb-4">
                                                        <h2 class="mb-0 fw-semibold">Most asked Checkout our knowledge base for some of your answer </h2>
                                                    </div>
                                                    <div class="accordion accordion-flush" id="accordionExample">
                                                        <div class="border p-3 rounded-3 mb-2" id="headingOne">
                                                            <h3 class="mb-0 fs-4">
                                                                <a href="#" class="d-flex align-items-center text-inherit active" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                                                    <span class="me-auto">What is scholarship ?
                                                                    </span>
                                                            ...
                                                            <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                                                                <div class="pt-2">
                                                                    A scholarship is essentially a form of financial aid awarded to students to assist with their education expenses. It's often granted based on academic merit, financial need, or other qualifying criteria, helping students pursue their educational goals without the burden of repayment.
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <!-- Card  -->
                                                        ...
                                                        <div class="border p-3 rounded-3 mb-2" id="headingTwo">
                                                            <h3 class="mb-0 fs-4">
                                                                <a href="#" class="d-flex align-items-center text-inherit" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                                                                    <span class="me-auto">How scholarspot AI work ?
                                                            ...
                                                            <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
                                                                <div class="pt-3">
                                                                    Scholarship AI works by leveraging artificial intelligence algorithms to streamline and optimize the scholarship application process. It can assist in various stages of the process, including:

                                                                    1. Matching: Scholarship AI algorithms analyze students' profiles, including academic achievements, extracurricular activities, demographics, and interests, to match them with relevant scholarship opportunities.
                                                                    
                                                                    2. Recommendations: Based on the user's profile and preferences, the AI system can recommend scholarships that align with their qualifications and interests, increasing their chances of success.
                                                                    
                                                                    3. Personalised Guidance: Scholarship AI can provide personalised guidance to students on how to improve their scholarship applications, including tips on writing compelling essays, preparing for interviews, and meeting deadlines.
                                                                    
                                                                    4. Automation: AI can automate repetitive tasks such as filling out application forms, sending reminders for deadlines, and tracking the status of applications, saving time and reducing errors.
                                                                    
                                                                    5. Data Analysis: AI algorithms can analyse large datasets of scholarship information to identify trends, patterns, and gaps in funding opportunities, enabling organisations to better target their resources and improve equity in scholarship distribution.
                                                                    
                                                                    Overall, scholarship AI aims to make the scholarship application process more accessible, efficient, and equitable for students, helping them secure funding for their education.
                                                        ...
                                                        <div class="border p-3 rounded-3 mb-2" id="headingSix">
                                                            <h3 class="mb-0 fs-4">
                                                                <a href="#" class="d-flex align-items-center text-inherit active" data-bs-toggle="collapse" data-bs-target="#collapseSix" aria-expanded="false" aria-controls="collapseSix">
                                                        ...
                                                        <div class="border p-3 rounded-3 mb-2" id="headingSeven">
                                                            <h3 class="mb-0 fs-4">
                                                                <a href="#" class="d-flex align-items-center text-inherit active" data-bs-toggle="collapse" data-bs-target="#collapseSeven" aria-expanded="false" aria-controls="collapseSeven">
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-lg-6 col-md-8">
                                    ...
                                    <div>
                                        ...
                                        <!-- heading -->
                                        <h2 class="h1">    <h1>What Our Users Say</h1></h2>
                                        <p class="mb-0">
                                            <p>Discover how our platform has helped individuals like you in their scholarship search journey.</p>
                                        </p>
                                    </div>
                                </div>
                                    ...
                                    <div class="item">
                                        <div class="card">
                                            <div class="card-body text-center p-6">
                                                ...
                                                <p class="mb-0 mt-3">
                                                    "As a parent, I always worried about how my child would afford college. Thanks to this platform, we found numerous scholarship opportunities matching my child's profile."
                                                </p>
                                                <!-- rating -->
                                    ...
                                    <div class="item">
                                        <div class="card">
                                            <div class="card-body text-center p-6">
                                                ...
                                                <p class="mb-0 mt-3">
                                                    "This platform made finding scholarships so much easier for me. With its powerful filters and personalized search, I was able to find scholarships tailored to my needs."
                                                </p>
                                                <!-- rating -->
                                                <div class="lh-1 mb-3 mt-4">
                                                    <span class="fs-6 align-top">
                                    ...
                                    <div class="item">
                                        <div class="card">
                                            <div class="card-body text-center p-6">
                                                ...
                                                <p class="mb-0 mt-3">
                                                    "I recommend this platform to all my students. It's user-friendly and provides valuable scholarship information. It's truly a game-changer in the scholarship search process."
            </blockquote>
                                                </p>
                                                <!-- rating -->
                                                <div class="lh-1 mb-3 mt-4">
                                    ...
                                    <div class="item">
                                        <div class="card">
                                            <div class="card-body text-center p-6">
                                                ...
                                                <p class="mb-0 mt-3">
                                                    "In my years of guiding students through the college application process, I've never come across a more comprehensive scholarship search platform. It's a must-have tool for any college-bound student."
                                                </p>
                                                <div class="lh-1 mb-3 mt-4">
                                                    <!-- rating -->
                                                    <span class="fs-6 align-top">
                                    ...
                                    <div class="item">
                                        <div class="card">
                                            <div class="card-body text-center p-6">
                                                ...
                                                <p class="mb-0 mt-3">
                                                    "Without this platform, I wouldn't have discovered the scholarship that funded my entire college education. It's an invaluable resource for students seeking financial aid."
                                                </p>
                                                <!-- rating -->
                                                <div class="lh-1 mb-3 mt-4">
                                                    <span class="fs-6 align-top">
    ...
    <div class="container mt-lg-2">
        <div class="row">
            <div class="col-lg-4 col-md-6 col-12">
                <!-- about company -->
                <div class="mb-4">
                    <img src="https://geeksui.codescandy.com/geeks/assets/images/brand/logo/logo.svg" alt="Geeks" class="logo-inverse" />
                    <div class="mt-4">
                        <p>ScholarHub is your comprehensive solution for finding the perfect scholarships tailored to your needs. With our powerful search filters, personalized recommendations, and user-friendly interface, we empower students, parents, and educators to navigate the complex world of scholarships with ease.</p>
                        <!-- social media -->
                        <div class="fs-4 mt-4">
                            <!--Facebook-->
                            <a href="#" class="me-2">
                ...
                <div class="d-lg-flex align-items-center">
                    <div class="me-4">
                        <span>
                            ...
                            <span>Designed and Developed by Team Logic Lords</span>
                        </span>
                    </div>
                    <div>
...
<!-- Mirrored from geeksui.codescandy.com/geeks/pages/landings/home-academy.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 21 Mar 2024 13:17:00 GMT -->
</html>
